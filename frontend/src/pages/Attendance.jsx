    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 disabled:opacity-50"
        >
              ...
              {isLoading ? (
                ...
                attendance.map((record, index) => (
                  <tr key={record.id || index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <div className={`flex items-center gap-2 font-medium ${record.check_out_time ? 'text-red-600' : 'text-gray-400'}`}>
                        <Clock className="w-4 h-4" />
